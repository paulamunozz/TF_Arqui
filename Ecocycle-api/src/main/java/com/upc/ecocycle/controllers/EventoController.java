...
public class EventoController {
    ...
    @PostMapping("/listarDisponibleParaVecino")
    @PreAuthorize("hasRole('VECINO')")
    public List<EventoDTO> listarEventosDisponiblesParaVecino(@RequestBody JsonNode filtros){
        eventoService.actualizarPesoActual();

        Integer vecinoId = filtros.get("vecinoId").asInt();
        String distrito = filtros.get("distrito").asText();
        ...
        return eventoService.listarEventosDisponiblesParaVecino(vecinoId, distrito, nombre, tipo, metodo, fechaInicio, fechaFin);
    }
